...
class CIFARBatchTransform(nn.Module):
    ...
    The dataset provides raw uint8 images in CHW format. This module applies
    CIFAR train/eval preprocessing on a full batch and returns normalized
    float32 224x224 tensors for the encoders.
    """
